...
CREATE TABLE `doctor` (
  ...
  `consultSchedule` varchar(45) DEFAULT NULL,
  `docAvailableSchedule` varchar(45) CHARACTER SET latin1 COLLATE latin1_bin DEFAULT NULL,
  `consultRoom` varchar(45) DEFAULT NULL,
  `timeIn` varchar(45) DEFAULT NULL,
  `timeOut` varchar(45) DEFAULT NULL,
  `doctorcol` varchar(45) CHARACTER SET latin1 COLLATE latin1_bin DEFAULT NULL,
  PRIMARY KEY (`docName`)
